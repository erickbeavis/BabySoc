...
<html>
	<head>
		...
		<title><s:text name="Funcionarios Cadastrados"/></title>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<s:form action="/excluirFuncionarios.action" method="post">
						<s:hidden name="funcionarioVo.rowid" id="funcionarioId" value="" />
	...
	<script>
		...
		const hiddenInput = form.querySelector("#funcionarioId");

		modal.addEventListener("show.bs.modal", function(e) {
			const funcionarioId = e.relatedTarget.getAttribute("data-id");
			hiddenInput.value = funcionarioId;
		});
	</script>
	</body>
</html>