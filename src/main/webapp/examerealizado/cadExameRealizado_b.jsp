...
<html>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<s:form action="/excluirExamesRealizados.action" method="post">
						<s:hidden name="exameRealizadoVo.rowid" id="exameRealizadoId" value="" />
	...
	<script>
		...
		const hiddenInput = form.querySelector("#exameRealizadoId");

		modal.addEventListener("show.bs.modal", function(e) {
			const exameRealizadoId = e.relatedTarget.getAttribute("data-id");
			hiddenInput.value = exameRealizadoId;
		});
	</script>
	</body>
</html>