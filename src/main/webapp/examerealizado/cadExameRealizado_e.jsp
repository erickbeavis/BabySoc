...
<html>
    ...
    <body class="bg-secondary">
        ...
        <div class="container">
            <s:form action="/editarExamesRealizados.action">
                ...
                <div class="card mt-5">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-sm">
                                <h5 class="card-title">Editar Exames Realizados</h5>
                            </div>
                        </div>
                    </div>
					...
					<div class="row align-items-center mt-3">
							...
							<div class="col-sm-5">
								<s:select
									...
									listKey="rowid"
									listValueKey="nome"
									value="%{exameRealizadoVo.funcionarioId}"
								/>
							</div>
					</div>
					<div class="row align-items-center mt-3">
							...
							<div class="col-sm-5">
								<s:select
									...
									listKey="rowid"
									listValueKey="nome"
									value="%{exameRealizadoVo.exameId}"
								/>
							</div>
					</div>
						...
						<div class="row align-items-center mt-3">
							...
							<div class="col-sm-2">
								<input type="date" class="form-control" id="data" value="${exameRealizadoVo.paraInputData()}" name="exameRealizadoVo.data" />
							</div>
						</div>
					</div>
